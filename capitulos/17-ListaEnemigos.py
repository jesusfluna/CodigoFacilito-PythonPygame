...
def cargar_enemigos():
    ...
    enemigo_dos = Invasor(170, 10, 180, 'imagenes/Marciano2A.jpg', 'imagenes/Marciano2B.jpg')
    lista_enemigo.append(enemigo_dos)

    enemigo_tres = Invasor(350, 200, 300, 'imagenes/Marciano3A.jpg', 'imagenes/Marciano3B.jpg')
