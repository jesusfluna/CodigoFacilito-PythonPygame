...
class NaveEspacial(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.vida = True
        self.velocidad = 20
        self.sonido_disparo = pygame.mixer.Sound("sonidos/disparo.wav")#Añadismo el sonido de un disparo
...
def space_invader():
    ...
    pygame.mixer.music.load("sonidos/bso.mp3")#Añadimos la musica de fondo
    pygame.mixer.music.play(3)#Iniciamos la reproduccion del audio y el numero de veces que se repetirá
